...
const db = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$supabase$2d$js$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createClient"])(supabaseUrl, supabaseAnonKey, {
    auth: {
        persistSession: true,
...
"[project]/lib/db/users.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getUserById(userId) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].from('users').select('*').eq('id', userId).single();
    if (error) {
...
async function getUserByEmail(email) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].from('users').select('*').eq('email', email).single();
    if (error) {
        if (error.code === 'PGRST116') return null;
...
async function updateUserProfile(userId, updates) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].from('users').update({
...
async function getAllUsers() {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].from('users').select('*').order('created_at', {
        ascending: false
    });
...
"[project]/lib/db/blogs.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
// ============================================================
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/db/client.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$users$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/db/users.ts [app-route] (ecmascript)");
;
;
async function getPublishedBlogs(category, limit = 20, offset = 0) {
    let query = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].from('blog_posts').select(`
...
async function getBlogBySlug(slug) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].from('blog_posts').select(`
      id, title, slug, content, excerpt, featured_image_url,
      category, company_name, role_applied, interview_round,
      status, is_featured, allow_comments,
      view_count, like_count, comment_count,
...
async function createBlogPost(authorId, title, slug, content, category, excerpt, featuredImageUrl, companyName, roleApplied, interviewRound, publishNow = false) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].from('blog_posts').insert({
        author_id: authorId,
        title,
        slug,
        content,
...
async function publishBlogPost(blogId) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].from('blog_posts').update({
        status: 'published',
...
async function deleteBlogPost(blogId) {
    const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].from('blog_posts').delete().eq('id', blogId);
...
function mapBlogPost(row) {
    return {
        ...
        createdAt: row.created_at,
        updatedAt: row.updated_at,
        author: row.author ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$users$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["mapUser"])(row.author) : undefined
    };
}
async function incrementBlogViews(blogId) {
    const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].rpc('increment_blog_views', {
        blog_id: blogId
    });
...
"[project]/lib/db/organizations.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getUserPositions(userId) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].from('user_positions').select(`
...
async function getOrganizations(type) {
    let query = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].from('organizations').select('*').eq('is_active', true).order('name');
    if (type) {
...
async function getOrganizationBySlug(slug) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].from('organizations').select('*').eq('slug', slug).single();
    if (error) {
        if (error.code === 'PGRST116') return null;
...
async function getChildOrganizations(parentId) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].from('organizations').select('*').eq('parent_id', parentId).eq('is_active', true).order('name');
    if (error) throw new Error(`[getChildOrganizations] ${error.message}`);
    return (data ?? []).map(mapOrganization);
}
async function getOrgMembers(orgId) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].from('org_members').select(`
...
async function createOrganization(data) {
    const { data: newOrg, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].rpc('admin_create_organization', {
...
async function updateOrganization(id, data) {
    const { data: updatedOrg, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].rpc('admin_update_organization', {
        p_id: id,
        p_name: data.name ?? null,
        p_slug: data.slug ?? null,
        p_type: data.type ?? null,
...
async function assignUserPosition(data) {
    ...
    const { data: newPosition, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].rpc('admin_assign_por', {
    ...
    if (newPosition) {
        const { data: joinedPosition } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].from('user_positions').select(`
                id, user_id, org_id, title, por_type, valid_from, valid_until, is_active, created_at,
                user:users!user_positions_user_id_fkey(id, email, full_name, role, profile_picture_url, enrollment_number, employee_id),
                org:organizations(id, name, slug, type, parent_id, logo_url, is_active)
...
async function revokeUserPosition(positionId) {
    const { data: success, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].rpc('admin_revoke_por', {
...
async function upsertOrganization(row) {
    const { data: org, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].rpc('admin_upsert_organization', {
        p_name: row.name,
        p_slug: row.slug,
        p_type: row.type,
...
async function upsertMemberByEntry(row) {
    const { data: member, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].rpc('admin_upsert_member', {
...
async function upsertPORByEntry(row) {
    const { data: por, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].rpc('admin_upsert_por', {
        p_entry_number: row.entry_number,
        p_org_slug: row.org_slug,
        p_title: row.title,
...
async function addOrgMember(orgId, userId) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].from('org_members').insert({
        org_id: orgId,
        user_id: userId,
        status: 'approved'
    }).select(`
...
async function removeOrgMember(orgId, userId) {
    const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].from('org_members').update({
        status: 'removed'
...
function mapUserPosition(row) {
    return {
        ...
        user: row.user ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$users$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["mapUser"])(row.user) : undefined
    };
}
...
"[project]/lib/db/events.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/db/client.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$users$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/db/users.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$organizations$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/db/organizations.ts [app-route] (ecmascript)");
;
;
;
async function getUpcomingEvents(type, limit = 20, page = 1) {
    ...
    let query = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].from('events').select(`
...
async function getEventBySlug(slug) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].from('events').select(`
      *,
      organizer:organizations!events_organizer_id_fkey(id, name, slug, type, logo_url),
...
async function createEvent(eventData) {
    ...
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].from('events').insert([
        {
...
function mapEvent(row) {
    return {
        ...
        createdAt: row.created_at,
        updatedAt: row.updated_at,
        organizer: row.organizer ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$organizations$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["mapOrganization"])(row.organizer) : undefined,
        // Note: Event interface expects `poster` to be populated for the ui
        poster: row.postedBy ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$users$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["mapUser"])(row.postedBy) : undefined
    };
}
}),
"[project]/lib/db/marketplace.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getMarketplaceItems(filters = {}) {
    ...
    const start = (page - 1) * limit;
    const end = start + limit - 1;
    let query = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].from('marketplace_items').select(`
...
async function getMarketplaceItemById(id) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].from('marketplace_items').select(`
      *,
...
async function createMarketplaceItem(itemData) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].from('marketplace_items').insert([
        {
...
async function updateMarketplaceItemStatus(id, status) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].from('marketplace_items').update({
        status
    }).eq('id', id).select(`
      *,
      seller:users!marketplace_items_seller_id_fkey(id, email, full_name, role, profile_picture_url)
...
function mapMarketplaceItem(row) {
    return {
        ...
        createdAt: row.created_at,
        updatedAt: row.updated_at,
        seller: row.seller ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$users$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["mapUser"])(row.seller) : undefined
    };
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/db/client.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$users$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/db/users.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$blogs$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/db/blogs.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$events$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/db/events.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$marketplace$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/db/marketplace.ts [app-route] (ecmascript)");
;
;
;
;
...
async function POST(request) {
    try {
        ...
        const { data: authData, error: signUpError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].auth.signUp({
            email,
            password
        });
        if (signUpError) {
        ...
        const { error: profileError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].rpc('create_user_profile', {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__45fa7670._.js.map