...
function MessagesPage() {
    ...
    const fetchConversations = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MessagesPage.useCallback[fetchConversations]": async ()=>{
            ...
            if (!u) return;
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].from('conversations').select('*, participant1:users!conversations_participant1_id_fkey(id, full_name, email, profile_picture_url, role, department), participant2:users!conversations_participant2_id_fkey(id, full_name, email, profile_picture_url, role, department)').or(`participant1_id.eq.${u.id},participant2_id.eq.${u.id}`).order('last_message_at', {
                ascending: false,
                nullsFirst: false
            });
    ...
    async function openConversationWith(other) {
        if (!user) return;
        const { data: existing } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].from('conversations').select('id').or(`and(participant1_id.eq.${user.id},participant2_id.eq.${other.id}),and(participant1_id.eq.${other.id},participant2_id.eq.${user.id})`).maybeSingle();
        let convId;
        if (existing) {
            convId = existing.id;
        } else {
...
_s(MessagesPage, "VAsHQo9N718GKWooIyGRqXBiZ84=", false, function() {
    return [
...
//# sourceMappingURL=_cf3514cf._.js.map