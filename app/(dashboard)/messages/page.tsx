  ...
  return (
    <div className="flex flex-col h-[calc(100vh-120px)]">
      ...
      <div className="grid flex-1 min-h-0" style={{ gridTemplateColumns: '300px 1fr' }}>
        ...
        {/* Right: Chat Area */}
        <div className="border border-l-0 border-border rounded-r-xl flex flex-col overflow-hidden bg-card">
          {showNewChat ? (
            <div className="flex flex-col flex-1 p-5 overflow-hidden">
              <div className="flex justify-between items-center mb-4">
                <h2 className="font-semibold text-lg">New Message</h2>
                <button onClick={() => setShowNewChat(false)} className="p-1.5 rounded-lg hover:bg-accent transition-colors"><X size={18} /></button>
              </div>
