-- ============================================================
-- 035_notices_date_filters_rpc.sql
-- Drop the old RPC and recreate it with date filters
-- ============================================================

DROP FUNCTION IF EXISTS public.get_visible_notices_json(TEXT,TEXT,TEXT,notice_category,notice_priority,notice_status,BOOLEAN,INTEGER,TIMESTAMPTZ,UUID,INTEGER);
...
COMMENT ON FUNCTION public.get_visible_notices_json(TEXT,TEXT,TEXT,notice_category,notice_priority,notice_status,BOOLEAN,INTEGER,TIMESTAMPTZ,UUID,INTEGER,TIMESTAMPTZ,TIMESTAMPTZ) IS 'Returns JSON with server-side filtered and paginated notices, supports date range.';

INSERT INTO _migrations (filename) VALUES ('035_notices_date_filters_rpc.sql') ON CONFLICT DO NOTHING;
